...
module Resolvers
  # Populates the data for the specimens Query
  class SpecimensResolver < Resolvers::BaseResolver
    include SearchObject.module(:graphql)
    type Types::SpecimenType::SpecimenConnectionWithTotalCountType, null: false
    description 'Returns a list of Specimens'

    scope { Pundit.policy_scope(context[:current_user], Specimen) }
    ...
    option :sort_direction,
           ...
           default: :asc,
           description: 'Sorts by created date either ascending or descending'
    option :owned_by,
           type: String,
