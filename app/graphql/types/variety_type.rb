...
module Types
  ...
  class VarietyType < Types::BaseObject # rubocop:disable Metrics/ClassLength
    ...
    field :owner_organization, Types::OrganizationType, null: true,
                                                        description: 'The organization that owns this variety.'
    field :source_organization, Types::OrganizationType, null: true,
                                                         description: 'The organization that originally sourced this variety.'
    field :created_by_principal, Types::PrincipalType, null: true,
                                                       description: 'The principal that created this variety.'
    field :publication_state, Types::PublicationStateEnum, null: true,
                                                           description: 'Whether this variety is a draft or published.'
    field :access_level, Types::AccessLevelEnum, null: true,
                                                 description: 'Whether this variety is visible to the owning organization only or publicly.'
    field :deleted_at, GraphQL::Types::ISO8601DateTime, null: true,
                                                        description: 'When this variety was soft-deleted, or null if not deleted.'
    ...
    field :record_history, Types::ChangeEntryType::ChangeEntryConnectionWithTotalCountType,
          description: 'Audit timeline for this variety and its common names, relation links and images, newest first. Visible only to users who may edit the variety.',
          null: true,
          connection: true,
          max_page_size: 50
    ...
    # CapabilityFields overrides: Variety supports soft-delete and restore.
