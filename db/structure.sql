...
CREATE TABLE public.plants (
    ...
    n_accumulation_range int4range,
    biomass_production_range numrange,
    optimal_temperature_range int4range,
    optimal_rainfall_range int4range,
    seasonality_days_range int4range,
    optimal_altitude_range int4range,
    ph_range numrange,
