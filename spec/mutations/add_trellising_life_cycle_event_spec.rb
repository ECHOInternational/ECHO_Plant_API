...
RSpec.describe 'Add Trellising Life Cycle Event Mutation', type: :graphql_mutation do
  ...
  context 'with valid parameters' do
    ...
    it 'creates a record' do
      success_result = @result['data']['addTrellisingEventToSpecimen']['trellisingEvent']
