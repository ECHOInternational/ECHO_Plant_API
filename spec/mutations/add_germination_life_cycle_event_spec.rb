...
RSpec.describe 'Add Germination Life Cycle Event Mutation', type: :graphql_mutation do
  ...
  context 'with valid parameters' do
    ...
    it 'creates a record' do
      success_result = @result['data']['addGerminationEventToSpecimen']['germinationEvent']
